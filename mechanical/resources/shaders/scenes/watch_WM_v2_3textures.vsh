...
void main()
{
  ...
  rPosition.x = mPosition.x + uEnableTilt * ( 6.0 - mPosition.z ) * nCubeMatrix[2].x;
  rPosition.y = mPosition.y + uEnableTilt * ( 6.0 - mPosition.z ) * nCubeMatrix[2].y;
