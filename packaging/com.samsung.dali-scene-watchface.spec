...
Name:       com.samsung.dali-scene-watchface
Summary:    Watchface scene for DALi scene launcher.
Version:    1.0.0
Release:    1
...
%description
Basic watch face scene for dali-scene-launcher.
...
%define model_template_name watchface
